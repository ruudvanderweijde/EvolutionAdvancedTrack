...
static final int TRANSACTION_setPokeLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getSupportedWakeLockFlags = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setStayOnSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setMaximumScreenOffTimeount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_preventScreenOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_isScreenOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_reboot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_crash = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setBacklightBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setAttentionLight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
public void acquireWakeLock(int flags, android.os.IBinder lock, java.lang.String tag) throws android.os.RemoteException;
public void goToSleep(long time) throws android.os.RemoteException;
public void goToSleepWithReason(long time, int reason) throws android.os.RemoteException;
