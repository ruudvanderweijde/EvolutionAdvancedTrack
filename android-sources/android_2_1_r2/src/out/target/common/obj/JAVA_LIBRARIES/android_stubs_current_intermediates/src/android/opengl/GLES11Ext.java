...
public static native  void glMatrixIndexPointerOES(int size, int type, int stride, java.nio.Buffer pointer);
public static native  void glWeightPointerOES(int size, int type, int stride, java.nio.Buffer pointer);
