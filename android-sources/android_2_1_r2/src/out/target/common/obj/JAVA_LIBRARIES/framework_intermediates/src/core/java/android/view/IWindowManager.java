...
static final int TRANSACTION_updateOrientationFromAppTokens = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
...
static final int TRANSACTION_disableKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_reenableKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_exitKeyguardSecurely = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_inKeyguardRestrictedInputMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_closeSystemDialogs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_getAnimationScale = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getAnimationScales = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_setAnimationScale = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_setAnimationScales = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_getSwitchState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_getSwitchStateForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getScancodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getScancodeStateForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_getTrackballScancodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getDPadScancodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getKeycodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_getKeycodeStateForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_getTrackballKeycodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_getDPadKeycodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_hasKeys = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_setInTouchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_setRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_getRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
