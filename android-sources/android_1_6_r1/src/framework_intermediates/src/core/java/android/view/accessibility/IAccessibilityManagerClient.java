...
/**
 * Cast an IBinder object into an IAccessibilityManagerClient interface,
...
mRemote.transact(Stub.TRANSACTION_setEnabled, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_setEnabled = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void setEnabled(boolean enabled) throws android.os.RemoteException;
}
