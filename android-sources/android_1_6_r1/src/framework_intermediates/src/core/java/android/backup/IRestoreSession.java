...
/**
 * Cast an IBinder object into an IRestoreSession interface,
...
static final int TRANSACTION_getAvailableRestoreSets = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_performRestore = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_endRestoreSession = (IBinder.FIRST_CALL_TRANSACTION + 2);
}
/**
     * Ask the current transport what the available restore sets are.
     *
