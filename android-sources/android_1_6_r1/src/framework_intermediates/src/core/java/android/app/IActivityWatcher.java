...
mRemote.transact(Stub.TRANSACTION_activityResuming, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
mRemote.transact(Stub.TRANSACTION_closingSystemDialogs, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_activityResuming = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_closingSystemDialogs = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void activityResuming(int activityId) throws android.os.RemoteException;
public void closingSystemDialogs(java.lang.String reason) throws android.os.RemoteException;
}
