...
static final int TRANSACTION_getSearchablesInGlobalSearch = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getSearchablesForWebSearch = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getDefaultSearchableForWebSearch = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_setDefaultWebSearch = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_startSearch = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_stopSearch = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_isVisible = (IBinder.FIRST_CALL_TRANSACTION + 7);
}
public android.server.search.SearchableInfo getSearchableInfo(android.content.ComponentName launchActivity, boolean globalSearch) throws android.os.RemoteException;
public java.util.List<android.server.search.SearchableInfo> getSearchablesInGlobalSearch() throws android.os.RemoteException;
public java.util.List<android.server.search.SearchableInfo> getSearchablesForWebSearch() throws android.os.RemoteException;
