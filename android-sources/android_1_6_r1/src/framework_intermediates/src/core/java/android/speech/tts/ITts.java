...
public int isLanguageAvailable(java.lang.String language, java.lang.String country, java.lang.String variant) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
static final int TRANSACTION_setSpeechRate = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_setPitch = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_speak = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_isSpeaking = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_stop = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_addSpeech = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_addSpeechFile = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getLanguage = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_isLanguageAvailable = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setLanguage = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_synthesizeToFile = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_playEarcon = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_addEarcon = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_addEarconFile = (IBinder.FIRST_CALL_TRANSACTION + 13);
...
static final int TRANSACTION_playSilence = (IBinder.FIRST_CALL_TRANSACTION + 16);
}
public int setSpeechRate(java.lang.String callingApp, int speechRate) throws android.os.RemoteException;
public int setPitch(java.lang.String callingApp, int pitch) throws android.os.RemoteException;
public int speak(java.lang.String callingApp, java.lang.String text, int queueMode, java.lang.String[] params) throws android.os.RemoteException;
