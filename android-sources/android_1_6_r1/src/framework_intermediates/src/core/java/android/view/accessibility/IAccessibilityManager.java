...
/**
 * Cast an IBinder object into an IAccessibilityManager interface,
...
static final int TRANSACTION_addClient = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_sendAccessibilityEvent = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getAccessibilityServiceList = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_interrupt = (IBinder.FIRST_CALL_TRANSACTION + 3);
}
public void addClient(android.view.accessibility.IAccessibilityManagerClient client) throws android.os.RemoteException;
public boolean sendAccessibilityEvent(android.view.accessibility.AccessibilityEvent uiEvent) throws android.os.RemoteException;
public java.util.List<android.content.pm.ServiceInfo> getAccessibilityServiceList() throws android.os.RemoteException;
