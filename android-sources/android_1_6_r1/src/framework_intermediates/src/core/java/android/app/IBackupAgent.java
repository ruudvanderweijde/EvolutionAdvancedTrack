...
/**
 * Cast an IBinder object into an IBackupAgent interface,
...
this.doBackup(_arg0, _arg1, _arg2);
...
this.doRestore(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
}
...
/**
     ...
     */
public void doBackup(android.os.ParcelFileDescriptor oldState, android.os.ParcelFileDescriptor data, android.os.ParcelFileDescriptor newState) throws android.os.RemoteException
{
...
mRemote.transact(Stub.TRANSACTION_doBackup, _data, _reply, 0);
...
/**
     ...
     */
public void doRestore(android.os.ParcelFileDescriptor data, int appVersionCode, android.os.ParcelFileDescriptor newState) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_doRestore, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_doBackup = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_doRestore = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
/**
     * Request that the app perform an incremental backup.
     *
