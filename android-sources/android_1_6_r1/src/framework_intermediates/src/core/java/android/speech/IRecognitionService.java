...
/**
 * Cast an IBinder object into an IRecognitionService interface,
...
static final int TRANSACTION_getRecognitionResults = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_cancel = (IBinder.FIRST_CALL_TRANSACTION + 2);
}
// Start listening for speech. Can only call this from one thread at once.
// see RecognizerIntent.java for constants used to specify the intent.
