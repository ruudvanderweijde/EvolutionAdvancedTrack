...
static final int TRANSACTION_isProtectedBroadcast = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_checkSignatures = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getPackagesForUid = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getNameForUid = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getUidForSharedUser = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_resolveIntent = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_queryIntentActivities = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_queryIntentActivityOptions = (IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_queryIntentReceivers = (IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_resolveService = (IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_queryIntentServices = (IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getInstalledPackages = (IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getInstalledApplications = (IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getPersistentApplications = (IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_resolveContentProvider = (IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_querySyncProviders = (IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_queryContentProviders = (IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getInstrumentationInfo = (IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_queryInstrumentation = (IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_installPackage = (IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_deletePackage = (IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_getInstallerPackageName = (IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_addPackageToPreferred = (IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_removePackageFromPreferred = (IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_getPreferredPackages = (IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_addPreferredActivity = (IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_replacePreferredActivity = (IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_clearPackagePreferredActivities = (IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getPreferredActivities = (IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_setComponentEnabledSetting = (IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_getComponentEnabledSetting = (IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_setApplicationEnabledSetting = (IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getApplicationEnabledSetting = (IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_freeStorageAndNotify = (IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_freeStorage = (IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_deleteApplicationCacheFiles = (IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_clearApplicationUserData = (IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_getPackageSizeInfo = (IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_getSystemSharedLibraryNames = (IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_enterSafeMode = (IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_isSafeMode = (IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_systemReady = (IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_hasSystemUidErrors = (IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_performDexOpt = (IBinder.FIRST_CALL_TRANSACTION + 58);
}
public android.content.pm.PackageInfo getPackageInfo(java.lang.String packageName, int flags) throws android.os.RemoteException;
public int getPackageUid(java.lang.String packageName) throws android.os.RemoteException;
public int[] getPackageGids(java.lang.String packageName) throws android.os.RemoteException;
