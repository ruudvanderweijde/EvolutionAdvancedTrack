...
/**
 * Cast an IBinder object into an IAccessibilityServiceConnection interface,
...
mRemote.transact(Stub.TRANSACTION_setServiceInfo, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_setServiceInfo = (IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void setServiceInfo(android.accessibilityservice.AccessibilityServiceInfo info) throws android.os.RemoteException;
}
