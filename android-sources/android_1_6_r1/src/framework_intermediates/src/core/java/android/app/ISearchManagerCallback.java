...
/**
 * Cast an IBinder object into an ISearchManagerCallback interface,
...
mRemote.transact(Stub.TRANSACTION_onDismiss, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_onCancel, _data, null, IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_onDismiss = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_onCancel = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void onDismiss() throws android.os.RemoteException;
public void onCancel() throws android.os.RemoteException;
}
