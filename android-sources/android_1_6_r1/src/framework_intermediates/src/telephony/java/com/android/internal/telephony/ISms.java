...
static final int TRANSACTION_getAllMessagesFromIccEf = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_updateMessageOnIccEf = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_copyMessageToIccEf = (IBinder.FIRST_CALL_TRANSACTION + 2);
