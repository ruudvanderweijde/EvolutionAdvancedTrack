...
static final int TRANSACTION_getActivePhoneType = (IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getCdmaEriIconIndex = (IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getCdmaEriIconMode = (IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getCdmaEriText = (IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getVoiceMessageCount = (IBinder.FIRST_CALL_TRANSACTION + 34);
}
/**
     * Dial a number. This doesn't place the call. It displays
     * the Dialer screen.
