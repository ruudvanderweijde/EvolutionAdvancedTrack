...
case TRANSACTION_installLocationProvider:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
android.location.ILocationProvider _arg1;
_arg1 = android.location.ILocationProvider.Stub.asInterface(data.readStrongBinder());
this.installLocationProvider(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_installGeocodeProvider:
{
data.enforceInterface(DESCRIPTOR);
android.location.IGeocodeProvider _arg0;
_arg0 = android.location.IGeocodeProvider.Stub.asInterface(data.readStrongBinder());
this.installGeocodeProvider(_arg0);
reply.writeNoException();
return true;
}
}
...
public void installLocationProvider(java.lang.String name, android.location.ILocationProvider provider) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_installLocationProvider, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void installGeocodeProvider(android.location.IGeocodeProvider provider) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeStrongBinder((((provider!=null))?(provider.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_installGeocodeProvider, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_requestLocationUpdates = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_requestLocationUpdatesPI = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_removeUpdates = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_removeUpdatesPI = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_addGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_removeGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_locationCallbackFinished = (IBinder.FIRST_CALL_TRANSACTION + 8);
...
static final int TRANSACTION_reportLocation = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getFromLocation = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getFromLocationName = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_addTestProvider = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_removeTestProvider = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setTestProviderLocation = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_clearTestProviderLocation = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setTestProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_clearTestProviderEnabled = (IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_setTestProviderStatus = (IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_clearTestProviderStatus = (IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_installLocationProvider = (IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_installGeocodeProvider = (IBinder.FIRST_CALL_TRANSACTION + 27);
}
public java.util.List getAllProviders() throws android.os.RemoteException;
public java.util.List getProviders(boolean enabledOnly) throws android.os.RemoteException;
public void requestLocationUpdates(java.lang.String provider, long minTime, float minDistance, android.location.ILocationListener listener) throws android.os.RemoteException;
