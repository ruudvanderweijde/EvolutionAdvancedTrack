...
/**
 * Cast an IBinder object into an IGeocodeProvider interface,
...
static final int TRANSACTION_getFromLocation = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getFromLocationName = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public java.lang.String getFromLocation(double latitude, double longitude, int maxResults, java.lang.String language, java.lang.String country, java.lang.String variant, java.lang.String appName, java.util.List<android.location.Address> addrs) throws android.os.RemoteException;
public java.lang.String getFromLocationName(java.lang.String locationName, double lowerLeftLatitude, double lowerLeftLongitude, double upperRightLatitude, double upperRightLongitude, int maxResults, java.lang.String language, java.lang.String country, java.lang.String variant, java.lang.String appName, java.util.List<android.location.Address> addrs) throws android.os.RemoteException;
}
