...
/**
 * Cast an IBinder object into an IGpsStatusProvider interface,
...
static final int TRANSACTION_addGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_removeGpsStatusListener = (IBinder.FIRST_CALL_TRANSACTION + 1);
}
public void addGpsStatusListener(android.location.IGpsStatusListener listener) throws android.os.RemoteException;
public void removeGpsStatusListener(android.location.IGpsStatusListener listener) throws android.os.RemoteException;
}
