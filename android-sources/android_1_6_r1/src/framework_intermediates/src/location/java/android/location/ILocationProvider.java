...
/**
 * Cast an IBinder object into an ILocationProvider interface,
...
public void updateNetworkState(int state) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_requiresNetwork = (IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_requiresSatellite = (IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_requiresCell = (IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_hasMonetaryCost = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_supportsAltitude = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_supportsSpeed = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_supportsBearing = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getPowerRequirement = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getAccuracy = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_enable = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_disable = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_isEnabled = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getStatus = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getStatusUpdateTime = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_enableLocationTracking = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setMinTime = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_updateNetworkState = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_updateLocation = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_sendExtraCommand = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_addListener = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_removeListener = (IBinder.FIRST_CALL_TRANSACTION + 20);
}
public boolean requiresNetwork() throws android.os.RemoteException;
public boolean requiresSatellite() throws android.os.RemoteException;
public boolean requiresCell() throws android.os.RemoteException;
