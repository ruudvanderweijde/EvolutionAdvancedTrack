...
/**
 * Cast an IBinder object into an android.os.ICheckinService interface,
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeByteArray(crashData);
mRemote.transact(Stub.TRANSACTION_reportCrashAsync, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_checkin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_reportCrashSync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_reportCrashAsync = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_masterClear = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_getParentalControlState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
}
/** Synchronously attempt a checkin with the server, return true
      * on success.
      * @throws IllegalStateException whenever an error occurs.  The
