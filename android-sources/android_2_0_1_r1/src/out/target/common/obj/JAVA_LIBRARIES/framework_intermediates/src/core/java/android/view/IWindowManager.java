...
static final int TRANSACTION_getKeycodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getKeycodeStateForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_hasKeys = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_setInTouchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_setRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_getRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_watchRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
}
/**
     * ===== NOTICE =====
     * The first three methods must remain the first three methods. Scripts
