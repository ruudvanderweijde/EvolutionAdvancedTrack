...
this.setWallpaperPosition(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
...
/**
     ...
     */
public void setWallpaperPosition(android.os.IBinder windowToken, float x, float y) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
