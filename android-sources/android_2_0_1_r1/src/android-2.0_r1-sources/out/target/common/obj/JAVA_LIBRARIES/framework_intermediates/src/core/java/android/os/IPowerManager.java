...
public void setAutoBrightness(boolean on) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setAutoBrightness, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_userActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_userActivityWithForce = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_setPokeLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_getSupportedWakeLockFlags = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setStayOnSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getScreenOnTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_preventScreenOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setScreenBrightnessOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_setBacklightBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_setAutoBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
}
public void acquireWakeLock(int flags, android.os.IBinder lock, java.lang.String tag) throws android.os.RemoteException;
public void goToSleep(long time) throws android.os.RemoteException;
public void releaseWakeLock(android.os.IBinder lock) throws android.os.RemoteException;
